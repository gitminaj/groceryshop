...
<div class="wishlist">
   ...
   <form action="" method="POST" class="box">
      <a href="Wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times cross" onclick="return confirm('delete this from wishlist?');"></a>
   ...
   <div class="wishlist-total">
      <p>Grand total : <span style="color: firebrick;">₹<?= $grand_total; ?>/-</span></p>
      <div class="flex-btn">
