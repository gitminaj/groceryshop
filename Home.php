...
<body>
    ...
    <div class="home-bg">
        ...
        <div class="home">
            ...
            <div class="content">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto natus culpa officia quasi</p>
    ...
    <div class="home-category">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <h3>fruits</h3>
                <p>Farm fresh fruits, without any chemicals apllied </p>
            ...
            <div class="box">
                ...
                <h3>meat</h3>
                <p>Fresh meat and other non-veg products</p>
                <a href="category.php?category=meat" class="btn">meat</a>
            </div>

            <div class="box">
                <img src="images/vegitable.jpg" alt="">
                <h3>vegetables</h3>
                <p>Fresh vegetables, properly packed</p>
    ...
    <div class="show-products">
        ...
        <h1 class="title">Latest Products Added</h1>
   ...
   ?>
            <form action="" class="box" method="POST">
                <div class="price">₹<span class="white">
